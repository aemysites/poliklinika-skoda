...
## Environments
- Preview: https://main--poliklinika-skoda--aemysites.aem.page/
- Live: https://main--poliklinika-skoda--aemysites.aem.live/
- Block Library: https://main--poliklinika-skoda--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `poliklinika-skoda` directory in your favorite IDE and start coding :)
